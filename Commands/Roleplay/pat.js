...
export default class Pat extends Command {
    constructor(client) {
        super(client, {
            name: "acariciar",
            description: "Envie um GIF para acariciar um usuário!",
            aliases: ['pat', 'patpat', 'pat-pat'],
            usage: '<usuário>'
        })
    }
    ...
    async run(message, args) {
        ...
        let image = await axios.get('https://api.otakugifs.xyz/gif?reaction=pat')
        ...
        let embed = new EmbedBuilder()
            ...
            .setDescription(`😘 ${message.author.toString()} acariciou ${user.toString()}!`)
        ...
        collector.on("collect", async (interaction) => {
            ...
            image = await axios.get('https://api.otakugifs.xyz/gif?reaction=pat')
            embed = new EmbedBuilder()
                ...
                .setImage(image.data.url)
                .setDescription(`😘 ${user.toString()} retribuiu o carinho de ${message.author.toString()}!`)
