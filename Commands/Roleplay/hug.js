...
export default class Hug extends Command {
    constructor(client) {
        super(client, {
            name: "abraçar",
            description: "Envie um GIF para abraçar um usuário!",
            aliases: ['abraco', 'hug', 'abraço'],
            usage: '<usuário>'
        })
    }
    ...
    async run(message, args) {
        ...
        let image = await axios.get('https://api.otakugifs.xyz/gif?reaction=hug')
        ...
        let embed = new EmbedBuilder()
            ...
            .setDescription(`😘 ${message.author.toString()} deu um abraço em ${user.toString()}!`)
        ...
        collector.on("collect", async (interaction) => {
            ...
            image = await axios.get('https://api.otakugifs.xyz/gif?reaction=hug')
            embed = new EmbedBuilder()
                ...
                .setImage(image.data.url)
                .setDescription(`😘 ${user.toString()} retribuiu o abraço de ${message.author.toString()}!`)
