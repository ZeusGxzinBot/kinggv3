...
export default class Kiss extends Command {
    constructor(client) {
        super(client, {
            name: "beijar",
            description: "Envie um GIF para beijar um usuário!",
            aliases: ['kiss'],
            usage: '<usuário>'
        })
    }
    ...
    async run(message, args) {
        ...
        let image = await axios.get('https://api.otakugifs.xyz/gif?reaction=kiss')
        ...
        let embed = new EmbedBuilder()
            ...
            .setDescription(`😘 ${message.author.toString()} deu um beijo em ${user.toString()}!`)
        ...
        collector.on("collect", async (interaction) => {
            ...
            image = await axios.get('https://api.otakugifs.xyz/gif?reaction=kiss')
            embed = new EmbedBuilder()
                ...
                .setImage(image.data.url)
                .setDescription(`😘 ${user.toString()} retribuiu o beijo de ${message.author.toString()}!`)
